package com.github.TeThoLaPot.regen_resources.platform.forge.command;

import com.github.TeThoLaPot.regen_resources.platform.forge.network.ClientboundOpenRegenSettingsPacket;
...
public final class RegenSettingsCommands {
    ...
    public static void openSettingsFor(ServerPlayer player) {
        ...
        RegenResourcesNetwork.CHANNEL.send(
                PacketDistributor.PLAYER.with(() -> player), new ClientboundOpenRegenSettingsPacket(snapshot));
    }
}
