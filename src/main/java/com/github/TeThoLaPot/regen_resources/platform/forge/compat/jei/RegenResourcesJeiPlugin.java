package com.github.TeThoLaPot.regen_resources.platform.forge.compat.jei;

import com.github.TeThoLaPot.regen_resources.RegenResources;
import com.github.TeThoLaPot.regen_resources.platform.forge.client.screen.RegenTargetEditScreen;
...
/** JEI からターゲット編集画面の登録スロットへゴーストドロップする。 */
@JeiPlugin
