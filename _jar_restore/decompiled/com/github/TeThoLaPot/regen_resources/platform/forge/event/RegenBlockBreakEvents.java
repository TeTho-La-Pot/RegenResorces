...
public final class RegenBlockBreakEvents {
    ...
    private static boolean holdsActiveBreakStuff(Player player) {
        return RegenBlockBreakEvents.isActiveBreakStuff(player.m_21205_()) || RegenBlockBreakEvents.isActiveBreakStuff(player.m_21206_());
    }

    private static boolean isActiveBreakStuff(ItemStack stack) {
        return stack.m_41720_() instanceof BreakStuffItem && BreakStuffItem.isRemovalMode(stack);
    }
}
