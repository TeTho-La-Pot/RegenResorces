...
public enum RegenResourcesJadeRegenEligibleProvider implements IBlockComponentProvider
{
    ...
    public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig config) {
        ...
        if (srv.m_128471_("regen_j_rule_match")) {
            effective = srv;
        } else {
        ...
        if (!effective.m_128471_("regen_j_rule_match")) {
            return;
        }
        if (effective.m_128471_("regen_j_allows_regen")) {
            tooltip.add((Component)Component.m_237115_((String)"jade.regen_resources.regen_eligible").m_130940_(ChatFormatting.GREEN));
        } else {
            tooltip.add((Component)Component.m_237115_((String)"jade.regen_resources.regen_not_eligible").m_130940_(ChatFormatting.RED));
        }
    }
}
